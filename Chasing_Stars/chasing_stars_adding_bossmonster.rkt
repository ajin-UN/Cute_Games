...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname final-project-adding-bossmonster) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
;rules:
